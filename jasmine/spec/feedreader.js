...
$(function() {
  ...
  */
  ...
  describe('Inital Entries', function() {
    ...
    it('loadFeed has min one entry', function() {
  ...
  describe('New Feed Selection', function() {
    ...
    beforeEach(function(done) {
      loadFeed(0, function() {
        let onLoadContent = $('feed').text();
        loadFeed(1, function() {
          let newContent = $('feed').text();
          done();
        });
      });
    });

   it('loadFeed is updating', function() {
    expect(newContent).not.toEqual(onLoadContent);
   });
  });
}());
